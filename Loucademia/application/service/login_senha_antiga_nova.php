                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <form action="altera_senha_antiga_nova.php" method="POST" role="form">
                                            <p>Por favor, entre com sua senha antiga e a sua senha nova</p>

                                            <div class="form-outline mb-4">
                                                <label class="form-label" for="login">Senha antiga</label>
                                                <input type="password" id="senha_antiga" class="form-control" name="senha_antiga" required/>
                                            </div>

                                            <div class="form-outline mb-4">
                                                <label class="form-label" for="senha">Senha nova</label>
                                                <input type="password" id="senha_nova" class="form-control" name="senha_nova" required/>
                                            </div>
